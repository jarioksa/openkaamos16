...
- [cc.oulu.fi/~jarioksa/opencon/](http://cc.oulu.fi/~jarioksa/opencon/)
...
## Open Source Software: Personal Experience
...
## Open Source Resurrected --- and now really Open
...
- Based on **S**-language that was developed in the Bell Labs (where else?)
...
- Niche market for commercial developers: even most of the paid software developed by practicing scientists
...
- Distributed in Comprehensive R Archive Network [CRAN](https://cran.r-project.org/web/packages/vegan/index.html)
    - First released in 2001 when there were less than 200 packages --- now there are nearl 10000
...
- Licensed GPL2 (but not GPL3): free license that allows reuse of the code
...
- A large number of other **R** packages utilize **vegan** functionality
...
- Increasingly many journals require deposition of data


## A Simple Map

<div class="columns-2">
<img src="myricagale_map2.png" width="480px">

<a title="Sten [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0) or GFDL (http://www.gnu.org/copyleft/fdl.html)], via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File%3AMyrica-gale-foliage-male-catkins.jpg"><img width="512" alt="Myrica-gale-foliage-male-catkins" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Myrica-gale-foliage-male-catkins.jpg/512px-Myrica-gale-foliage-male-catkins.jpg"/></a>
</div>

... is based on [Biodiversity data base](http://www.gbif.org), [map data](http://cran.r-project.org/web/packages/rworldmap/), [cartographic projection](https://www.epsg-registry.org), [**R** tools for biodiversity](https://github.com/ropensci/rgbif) and [personal scripts](https://github.com/jarioksa/biogeo) --- all open and freely available
...
- &copy; Jari Oksanen 2015 [CC-BY](http://creativecommons.org/licences/by/4.0/)
